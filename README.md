![](https://github.com/udara/team_profile_generator/blob/master/img/screen_shot.jpg)
...
In the `Develop` folder, there is a `package.json`, so make sure to `npm install`. - done
